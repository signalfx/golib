...
// CastMetricValueBool casts an interface to datapoint Value and handles bool
func CastMetricValueBool(value interface{}) (metricValue Value, err error) {
	switch value.(type) {
	case bool: value = func() int {if value.(bool){ return 1}; return 0}()
	}
